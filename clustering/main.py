...
test_parser_1 = TestParser([
    ...
    #  ['2016', '8', '23'], ['2016', '8', '28']],
    [{'all_of': ['Aden', ], 'any_of':['military', 'bomb', 'suicide', 'attack', '\Wkill', '\Wtoll', ], },
     ['2016', '8', '29'], ['2016', '8', '29']],
    # [{'all_of': ['Kabul', 'attack'], 'any_of':['security', 'ministry', 'blast', '\Wbomb', 'militant', ], },
    #  ['2016', '9', '5'], ['2016', '9', '10']],
    # [{'any_of': ['bomb', '\Wkill', '\Wtoll', 'shopping', 'explosion', 'victim', 'wound', ],
    ...
    # [{'all_of': ['Madagali', ], 'any_of':['Adamawa', '\Wbomb', 'suicide', 'attack', '\Wkill', 'explosion', ], },
    #  ['2016', '12', '8'], ['2016', '12', '13']],
...
def parse_args():
    ...
    parser.add_argument('--pred', action='store_true', default=False,
                        help='If makes prediction on the test data.')
